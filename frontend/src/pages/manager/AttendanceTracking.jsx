...
const AttendanceTracking = () => {
  ...
  const handleExportAttendance = (format = 'pdf') => {
    ...
    if (format === 'excel') {
      ...
      // PDF format - create a simple HTML representation
      const html = `
        <html>
          <head>
          ...
          <body>
            ...
            <p>Overall Attendance: ${calculateOverallAttendance()}%</p>
    ...
    // For demo purposes, we'll create a download
