...
import team1 from "../images/DK.jpeg";
import team2 from "../images/Bhavika.jpeg";
import team3 from "../images/Mahek.jpeg";
      ...
      >
        ...
        <div className="p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label className="block text-sm font-medium mb-3">Why do you want to use LiteHR? *</label>
            ...
            >
              ...
              >
                ...
                <p className="text-sm" style={{ color: currentTheme.text.muted }}>
                  We'll get back to you soon with demo details.
                </p>
              </motion.div>
            </motion.div>
          )}
